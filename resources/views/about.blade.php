  ...
  -->
    <div class="min-h-full">
                            ...
                            <div class="relative ml-3">
                                <div>
                                    <button type="button" @click="isOpen = !isOpen" class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                                        ...
                                        <img class="h-8 w-8 rounded-full" src="https://avatars.githubusercontent.com/u/94433717?v=4" alt="">
                                    </button>
                                </div>
            ...
            <div x-show="isOpen" class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pb-3 pt-4">
                    <div class="flex items-center px-5">
                        <div class="flex-shrink-0">
                            <img class="h-10 w-10 rounded-full" src="https://avatars.githubusercontent.com/u/94433717?v=4" alt="">
                        </div>
                        <div class="ml-3">
                            <div class="text-base font-medium leading-none text-white">Wira Sukma Saputra</div>
                            <div class="text-sm font-medium leading-none text-gray-400">wiralodrasaputra07@gmail.com</div>
                        </div>
                    </div>
        ...
        <main>
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <!-- Your content -->
                <p class="mt-4">This is the about page. Here you can describe more about your website or your company.</p>
                <p class="mt-2">Feel free to add more information about your mission, vision, and the team behind this project.</p>
            </div>
        </main>
    </div>
</body>
